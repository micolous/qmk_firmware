...
/* Keymap 0: Basic layer (unchanged from qwerty version)
 *
 * ,-----------------------------.       ,--------------------------------.
 * |    " |  <  |  >  |  P  |  Y  |      |  F  |  G  |  C  |  R  |    L   |
 * |------+-----+-----+-----+-----|      |--------------------------------|
 ...
 * `------+-----+-----+-----+-----'      `--------------------------------'
 *  .-------------------------.           .-----------------.   
 *  |ESC/META|ENT/ALT|SPC(SYM)|           |SPC(NUM)|SHFT/BSPC|CTRL/TAB|
 *  '-------------------------'           '-----------------' 
 */
[BASE] = LAYOUT_gergoplex(
    ...
    MT(MOD_LSFT, KC_Z),KC_X, KC_C, KC_V, KC_B,  	KC_N, KC_M, KC_COMM, KC_DOT, MT(MOD_RSFT, KC_SLSH),
		...
		LT(NUMB, KC_SPC), MT(MOD_LSFT, KC_BSPC), MT(MOD_LCTL, KC_TAB)																// Right
    ),
/* Keymap 1: Symbols layer  (DV_* instead of KC_*)
 * ,-----------------------------.       ,--------------------------------.
 * |  !   |  @  |  {  |  }  |       |  `  |  ~  |     |     |    \   |
 * |-----+-----+-----+-----+------|      |--------------------------------|
 * |  #   |  $  |  (  |  )  | LMB |      |  +  |  -  |  /  |  *  |    '   | 
...
[SYMB] = LAYOUT_gergoplex(
    DV_EXLM, DV_AT,   DV_LCBR, DV_RCBR, DV_PIPE,   DV_GRV,  DV_TILD, KC_TRNS, KC_TRNS, DV_BSLS,
    DV_HASH, DV_DLR,  DV_LPRN, DV_RPRN, KC_BTN2,   DV_PLUS, DV_MINS, DV_SLSH, DV_ASTR, DV_QUOT,
    DV_PERC, DV_CIRC, DV_LBRC, DV_RBRC, KC_BTN1,   DV_AMPR, DV_EQL,  DV_COMM, DV_DOT,  DV_MINS,
                      CMB_TOG, DV_SCLN, DV_EQL,    DV_EQL,  DV_SCLN, KC_DEL
    ),
/* Keymap 2: Pad/Function layer (unchanged)
 * ,-----------------------------.       ,-------------------------------.
 * |  1   |  2  |  3  |  4  |  5  |      |  6  |  7  |  8  |  9  |   0   |
 * |-----+-----+-----+-----+------|      |-------------------------------|
